"""
Restaurant Management System — URLs (اصلاح‌شده)
"""
...
urlpatterns = [
    ...
    #  Foods & Categories
    # ──────────────────────────────────────────────────────────────
    # ⚠ api/foods/ و api/categories/ با router سایه می‌زنن.
    #    اگه به ViewSet از طریق router نیاز دارید،
    #    مسیرهای عمومی رو به api/public/foods/ تغییر بدید.
    ...
    # ──────────────────────────────────────────────────────────────
    #  REST API Router (باید آخر از همه باشه)
    # ──────────────────────────────────────────────────────────────
    ...
    path("dashboard/semi-finished/",    views.semi_finished_view,   name="semi_finished"),  # ← تایپی اصلاح شد
    ...
    # Recipes  ← هر دو مسیر به یک تابع وصل شدن
    path("dashboard/recipes/",         recipe_views.recipe_manager_page, name="recipes_page"),
